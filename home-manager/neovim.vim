...
map gp :lua require'dap'.toggle_breakpoint()<CR>
map gsg :lua require'dap-go'.setup()<CR>:lua require'dapui'.setup()<CR>:lua require('dap.ext.vscode').load_launchjs(nil,{cpptools="c","cpp"})<CR>
map gr :lua require'dap'.continue()<CR>
map go :lua require'dapui'.open({reset=true})<CR>
map gc :lua require'dapui'.close({reset=true})<CR>
